...
use std::{ net::{ TcpListener, TcpStream }, io::Read, io::Write, collections::HashMap, fs::write, time::{SystemTime, UNIX_EPOCH} };
...
fn main() {
    ...
    let  store: Arc<Mutex<HashMap<String, (String,u64)>>> = Arc::new(Mutex::new(std::collections::HashMap::new()));
...
fn get_set_cahcer(method: String, commands: &Vec<Option<String>>,store:&mut Arc<Mutex<HashMap<String,(String,u64)>>>) -> String {
